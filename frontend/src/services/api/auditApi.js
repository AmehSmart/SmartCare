...
import {
  getAuditEvents as backendGetAuditEvents,
  getAuditQueue as backendGetAuditQueue,
  verifyAuditChain as backendVerifyAuditChain,
} from "./backendAdapter";
...
export async function verifyAuditChain() {
  if (isBackendEnabled()) {
    return backendVerifyAuditChain();
  }
  await new Promise((resolve) => setTimeout(resolve, 250));
  return {
    integrityValid: true,
