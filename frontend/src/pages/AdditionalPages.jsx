...
export function AdminTOTP() {
  ...
  return <Shell title="TOTP enrolment" subtitle="Set up a second factor for emergency access.">
    <section className="extra-card extra-card--narrow extra-center extra-totp-card">
      ...
      <p className="extra-muted" style={{ fontSize: 12 }}>Note: this is a standalone enrolment demo. For break-glass in this demo, add the seeded doctor/nurse key <strong>JBSWY3DPEHPK3PXP</strong> manually instead of scanning here.</p>
